...
public class ComprobarNotas extends AsyncTask<Void,Void,String>{
    ...
    private String urla,codiuni,codiasi,tipo,codigo;

    public ComprobarNotas(Context c, String urla, RecyclerView notas, String codiuni, String codiasi, String tipo, String codigo) {
        this.c=c;
        this.urla = urla;
        this.notas = notas;
    ...
    private String comprobar() {
        ...
        if (Objects.equals(tipo,"doc")){
            ...
            try {
                ...
                bw.write(new EmpaqueComprobarNotas1(codiuni,codiasi,accion,codigo).packageData());
                bw.flush();
                bw.close();
                os.close();
